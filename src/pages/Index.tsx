...
const Index = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-black overflow-y-auto">
      <motion.div
      ...
      >
        {/* Main Card */}
        <Card className="overflow-hidden border border-gray-200 dark:border-gray-800 shadow-lg flex-1">
          <CardHeader className="bg-white dark:bg-gray-800 py-5 border-b border-gray-200 dark:border-gray-700">
            <CardTitle className="text-2xl font-bold text-center flex items-center justify-center gap-2">
              <MonitorIcon className="w-6 h-6 text-blue-500" />
              <span>Rhythm Scroller</span>
              <span className="text-sm bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full ml-2">
                PC Edition
              </span>
            </CardTitle>
          </CardHeader>
              ...
              <ScrollArea className="h-[500px] md:h-[600px]">
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 rounded-md bg-gray-50 dark:bg-gray-800/50 p-4 border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <FileVideo2 className="h-5 w-5 text-amber-500" />
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-4 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-md border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 mt-4">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              className="w-24 h-9 text-lg text-center font-bold"
                            />
                          ...
                          <Button
                            ...
                            className="h-9 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700"
                          >
                            {isPlayingMetronome ? "Stop" : "Test"}
                            <Volume2 className={`h-4 w-4 ml-1 ${isPlayingMetronome ? 'text-green-500' : 'text-gray-400'}`} />
                          </Button>
                        </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3 p-4 bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 rounded-md text-sm">
          ...
          <CardFooter className="flex flex-col gap-3 pt-4 p-6 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/30">
            {!canStart && (
              <div className="flex items-center text-amber-600 dark:text-amber-400 text-sm gap-1.5 w-full justify-center mb-2">
            ...
            <div className="grid grid-cols-1 gap-4 w-full">
              <Button 
                onClick={startPlayer} 
                disabled={!canStart}
                className="w-full py-6 text-lg bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-700 dark:hover:bg-blue-800"
              >
            ...
            <div className="text-center text-xs text-gray-500 mt-2 flex items-center justify-center gap-2">
              <span>Rhythm Scroller PC</span>
              <Separator orientation="vertical" className="h-3" />
              <span>v1.0.0</span>
              <Separator orientation="vertical" className="h-3" />
              <a href="#" className="flex items-center gap-1 hover:text-gray-700 dark:hover:text-gray-300">
